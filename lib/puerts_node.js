...
module.exports.include_dir = path.relative('.', path.join(__dirname, '..', 'puerts_libs', 'include'));
module.exports.src_dir = path.relative('.', path.join(__dirname, '..', 'puerts_libs', 'src'));
